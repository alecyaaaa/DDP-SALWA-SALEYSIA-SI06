...
lumba_lumba = ikan('ikan lumba-lumba', 'ikan kecil', 'air', 'melahirkan', 'abu-abu', 'air laut')
lumba_lumba.cetak_ikan()

lele = ikan('ikan lele', 'cacing', 'air', 'bertelur', 'kuning', 'air tawar')
lele.cetak_ikan()